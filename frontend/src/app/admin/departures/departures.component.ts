        ...
        <mat-card class="mobile-card clickable-card" (click)="openDetail(b)">
          <div class="mc-top">
            ...
            <div style="display:flex;align-items:center;gap:6px">
              @if (!isPast(b['departure']) && !reminder.hasSent(b['id'], b['propId'] ?? b['propertyId'], 'departure')) {
...
export class DeparturesComponent implements OnInit {
  ...
  openDetail(b: any): void {
    const ref = this.dialog.open(BookingDetailDialogComponent, { data: { ...b, templateContext: 'checkout' }, width: '600px' });
